...
private:
    ...
    std::unique_ptr<MenuBarComponent> mnuBar;
    std::unique_ptr<TabbedComponent> tabbox;
    
    std::unique_ptr<FilesPane> filespane;
    std::unique_ptr<AudioseqPane> audioseqpane;
    std::unique_ptr<MidiPane> midipane;
    std::unique_ptr<AudiobankPane> audiobankpane;
    ...
    std::unique_ptr<Yax0Codec> codec;
