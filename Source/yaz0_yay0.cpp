...
void Yax0Codec::run(){
    ...
    case 2: out = yay0_compress(*in, 0, in->getSize()); break;
    case 3: out = yaz0_compress(*in, 0, in->getSize()); break;
    }
}
 ...
 * if the decompression failed. Put this into a ScopedPointer<ROM>.
 * Parameters:
 ...
 * if the compression failed. Put this into a ScopedPointer<ROM>.
 * Parameters:
 *   - input: A block of data containing the original data.
