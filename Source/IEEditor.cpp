    ...
    : ifile(ifile_), fp(fp_), entry(entry_)
{
    ...
    addAndMakeVisible (btnOverride = new TextButton ("new button"));
    ...
    addAndMakeVisible (lblAddress = new Label ("new label",
                                               TRANS("Address:")));
    lblAddress->setFont (Font (15.00f, Font::plain));
    ...
    addAndMakeVisible (txtAddress = new TextEditor ("new text editor"));
    ...
    txtAddress->setText (String::empty);

    addAndMakeVisible (lblAddress2 = new Label ("new label",
                                                TRANS("Length:")));
    lblAddress2->setFont (Font (15.00f, Font::plain));
    ...
    addAndMakeVisible (txtLength = new TextEditor ("new text editor"));
    ...
    txtLength->setText (String::empty);
    ...
    addAndMakeVisible (txtF1 = new TextEditor ("new text editor"));
    ...
    txtF1->setText (String::empty);

    addAndMakeVisible (txtF2 = new TextEditor ("new text editor"));
    ...
    txtF2->setText (String::empty);

    addAndMakeVisible (txtF3 = new TextEditor ("new text editor"));
    ...
    txtF3->setText (String::empty);

    addAndMakeVisible (txtF4 = new TextEditor ("new text editor"));
    ...
    txtF4->setText (String::empty);

    addAndMakeVisible (txtF5 = new TextEditor ("new text editor"));
    ...
    txtF5->setText (String::empty);

    addAndMakeVisible (txtF6 = new TextEditor ("new text editor"));
    ...
    txtF6->setText (String::empty);

    addAndMakeVisible (txtF7 = new TextEditor ("new text editor"));
    ...
    txtF7->setText (String::empty);

    addAndMakeVisible (txtF8 = new TextEditor ("new text editor"));
...
<JUCER_COMPONENT documentType="Component" className="IEEditor" componentName=""
  ...
  <TEXTBUTTON name="new button" id="f9678002aca585d6" memberName="btnOverride"
              ...
              bgColOn="fff52307" buttonText="Override" connectedEdges="0" needsCallback="1"
              radioGroupId="0"/>
