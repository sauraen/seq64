      ...
      sbm(seq64.rom, seq64.romdesc, audioseq)
{
    ...
    addAndMakeVisible (grpSeqBanks = new GroupComponent ("new group",
    ...
    addAndMakeVisible (groupComponent = new GroupComponent ("ROM Properties",
    ...
    addAndMakeVisible (btnLoadObject = new TextButton ("new button"));
    ...
    addAndMakeVisible (btnSaveObject = new TextButton ("new button"));
    ...
    addAndMakeVisible (cbxSeqBank = new ComboBox ("new combo box"));
    cbxSeqBank->setEditableText (false);
    cbxSeqBank->setJustificationType (Justification::centredLeft);
    cbxSeqBank->setTextWhenNothingSelected (String::empty);
    ...
    lsmSeqBanks = new TextListModel();
    lsmSeqBanks->setListener(this);

    addAndMakeVisible(lstSeqBanks = new ListBox("SeqBanks", lsmSeqBanks));
...
void FilesPane::resized()
{
    ...
    btnMakeRoom->setBounds (304, 648, 80, 24);
    label8->setBounds (144, 648, 120, 24);
    txtMakeRoom->setBounds (264, 648, 40, 24);
    btnContentsCreate->setBounds (16, 648, 120, 24);
    btnContentsDestroy->setBounds (16, 672, 120, 24);
...
void FilesPane::comboBoxChanged (ComboBox* comboBoxThatHasChanged)
{
    ...
    else if (comboBoxThatHasChanged == cbxSeqBank)
    {
...
void FilesPane::buttonClicked (Button* buttonThatWasClicked)
{
    ...
    else if (buttonThatWasClicked == btnLoadObject)
    {
    ...
    else if (buttonThatWasClicked == btnSaveObject)
    {
    ...
    else if (buttonThatWasClicked == btnSBMAdd)
    {
    ...
    else if (buttonThatWasClicked == btnSBMDelete)
    {
...
<JUCER_COMPONENT documentType="Component" className="FilesPane" componentName=""
  ...
  <GROUPCOMPONENT name="new group" id="da1838da4937cc20" memberName="grpMFT" virtualName=""
                  explicitFocusOrder="0" pos="496 120 336 352" title="Master File Table"/>
  ...
  <TEXTBUTTON name="new button" id="7a397ef5edfd6693" memberName="btnMakeRoom"
              virtualName="" explicitFocusOrder="0" pos="304 648 80 24" buttonText="Make Room"
              connectedEdges="1" needsCallback="1" radioGroupId="0"/>
  ...
  <TEXTBUTTON name="new button" id="eebbc4936a2263c0" memberName="btnContentsCreate"
              virtualName="" explicitFocusOrder="0" pos="16 648 120 24" buttonText="Create"
  ...
  <TEXTBUTTON name="new button" id="f2d02ac2da1cc4fa" memberName="btnContentsDestroy"
              virtualName="" explicitFocusOrder="0" pos="16 672 120 24" buttonText="Destroy/Pointerize"
